...
const TenantRequestSummary: React.FunctionComponent<
  TenantRequestSummaryProps
> = ({ familyLongName, orderId, tenantRequest }) => {
  let formattedDate;
    ...
    <Box>
      <Stack spacing={0.5}>
        ...
        <Typography variant="h6">
          {formattedDate
            ? `Demande de changement de date pour le ${formattedDate}`
